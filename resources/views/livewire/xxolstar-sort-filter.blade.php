            ...
            <div class="relative grid cursor-pointer">
              ...
              <div x-show="openSort" @click.outside="openSort = false" class="origin-top-right absolute top-4 right-0 mt-2 w-40 rounded-md shadow-2xl bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                <div class="py-1" role="none">
                  ...
                  <a wire:click="$emit('sortFieldSelected','first_name')" class="font-medium text-gray-900 block px-4 py-2 text-sm">
                  ...
                  <a wire:click="$emit('sortFieldSelected','last_name')" class="font-medium text-gray-900 block px-4 py-2 text-sm">
                    <div class='grid grid-cols-2 items-center'>
                        <span>Last Name</span>
                  ...
                  <a wire:click="$emit('sortFieldSelected','created_at')" class="font-medium text-gray-900 block px-4 py-2 text-sm">
                    <div class='grid grid-cols-2 items-center'>
                        <span>Date</span>
