        ...
        <div class='adminKey'>
            ...
            <div class='rounded-2xl py-10 shadow-bigCard border px-7 border-fourteenth'>
                <div class='flex justify-around'>
                    ...
                    <div class='flex flex-col items-center shadow-bigCard rounded-sm py-12 px-12'>
                        ...
                        <h2 class='font-semibold text-sm text-fifth'>{{$number_of_bookings}}</h2>
                    </div>
                    <div class='flex flex-col items-center shadow-bigCard rounded-sm py-12 px-12'>
                        ...
                        <h2 class='font-semibold text-sm text-fifth'>{{$xxolstars}}</h2>
                    </div>
            ...
            <div id='chartDiv'>
                <div class='mt-8 flex justify-center items-center'>
                    <i onclick="changeYear('prev')" class="fas cursor-pointer fa-caret-left"></i>
                    <h1 id='currentYear' class="mx-4">2021</h1>
                    <i onclick="changeYear('next')" class="fas cursor-pointer fa-caret-right"></i>
                </div>
                <canvas id='myChart'>
