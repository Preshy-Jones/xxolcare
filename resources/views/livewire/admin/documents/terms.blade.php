<section class='col-start-2 col-end-8 py-8 px-7'>
    <div>
                ...
                <div>
                    <div class='flex justify-between my-5'>
                        <div class='flex items-center'>
                            <h2 class='text-4xl text-black font-semibold'>Term and conditions</h2>
                        </div>
                ...
                <div class='rounded-2xl py-10 shadow-bigCard border px-7 border-fourteenth'>
                    <div>
                        ...
                        <div
                            ...
                            <h3 class='text-sm font-medium text-fifth col-start-1 col-end-3'>{{$term['name']}}</h3>
                            <h3 class='text-sm font-medium text-fifth'>PDF</h3>
                            <h3 class='text-sm font-medium text-fifth'>{{ \Carbon\Carbon::parse($term['created_at'])->toTimeString()}}</h3>
                            <h3 class='text-sm font-medium text-fifth'>{{ \Carbon\Carbon::parse($term['created_at'])->toDateString()}}</h3>
                            {{-- <img src="{{ asset('images/shareicon.svg') }}" alt=""> --}}
                            <a href="{{$term['file_URL']}}" download>
        ...
        <div>
            <div class='flex justify-between my-5'>
                <div class='flex items-center'>
                    <h2 class='text-4xl text-black font-semibold'>Terms and conditions</h2>
                </div>
                <div class='grid grid-cols-2'>
