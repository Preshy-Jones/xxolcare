                ...
                <div>
                    <div class='flex justify-between my-5'>
                        <div class='flex items-center'>
                            <h2 class='text-4xl text-black font-semibold'>Invoices</h2>
                        </div>
                        <div>
                ...
                <div class='rounded-2xl py-10 shadow-bigCard border px-7 border-fourteenth'>
                    <div>
                        ...
                        <div
                            ...
                            <h3 class='text-sm font-medium text-fifth col-start-1 col-end-3'>{{$invoice['name']}}</h3>
                            <h3 class='text-sm font-medium text-fifth'>PDF</h3>
                            <h3 class='text-sm font-medium text-fifth'>{{ \Carbon\Carbon::parse($invoice['created_at'])->toTimeString()}}</h3>
                            <h3 class='text-sm font-medium text-fifth'>{{ \Carbon\Carbon::parse($invoice['created_at'])->toDateString()}}</h3>
